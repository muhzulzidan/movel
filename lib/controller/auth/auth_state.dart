  ...
  Future<bool> login(String email, String password) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Verify if session cookie is stored
        // List<Cookie> storedCookies =
        // await cookieJar.loadForRequest(Uri.parse(apiUrl));

        // await prefs.setString('cookies', "${storedCookies}");

        // if (storedCookies.isNotEmpty) {
        //   print("Session cookie is stored $storedCookies");
        //   return true; // Session cookie is stored
        // } else {
        //   print("Session cookie is not stored");
        //   return false; // Session cookie is not stored
        // }
        return true;
      } else {
        print("headers : ${response.headers}");
      ...
      print(error);
      print('Login autsatet error: $error');
      return false; // Return false to indicate failed login
    }
  }
}
